...
def main():
    ...
    fname = "20150805_cas9plas_pm.csv"
    ...
    layer_names = ['Strain', 'Media','Tech_Rep']
    col_list = ['L','k','x0','y0']
    
    strain_list = [['SC -cas 1', 'SC +cas 1', 'SC -cas 2', 'SC +cas 2', 'SC WT', 'KL -cas 1', 'KL +cas 1', 'KL -cas 2', 'KL +cas 2', 'KL WT',], ['SC', 'YP'],['TR1','TR2','TR3']]      
    ...
    wells[strain_list[0][2]] = [['B4','C4','D4'],['E4','F4','G4']]
    wells[strain_list[0][3]] = [['B5','C5','D5'],['E5','F5','G5']]
    wells[strain_list[0][4]] = [['B6','C6','D6'],['E6','F6','G6']]
    wells[strain_list[0][5]] = [['B7','C7','D7'],['E7','F7','G7']]
    wells[strain_list[0][6]] = [['B8','C8','D8'],['E8','F8','G8']]
    wells[strain_list[0][7]] = [['B9','C9','D9'],['E9','F9','G9']]
    wells[strain_list[0][8]] = [['B10','C10','D10'],['E10','F10','G10']]
    wells[strain_list[0][9]] = [['B11','C11','D11'],['E11','F11','G11']]
    ...
    legend_list = [ 'SC -Cas S1', 'SC +Cas S1', 'SC -Cas S2','SC +Cas S2','SC WT']
    color_list = ['b','g','b','g','k']
    linestyle_list = ['-','-','--','--','-']
    wells = []
    wells.append(['B2','B3','B4','B5','B6']) #S.Cer SC
    wells.append(['E2','E3','E4','E5','E6']) #S. Cer YP
    title_list = ['YP Media: S.Cer', 'SC Media: S.Cer']
    #Tracer()()
    for jj in range(2):
            ax = axarr[jj]   
    ...
    legend_list = [ 'KL -Cas S1', 'KL +Cas S1', 'KL -Cas S2','KL +Cas S2','KL WT']
    color_list = ['b','g','b','g','k']
    linestyle_list = ['-','-','--','--','-']
    wells = []
    wells.append(['B7','B8','B9','B10','B11']) #K.Lac SC
    wells.append(['E7','E8','E9','E10','E11']) #K.Lac YP
    title_list = ['YP Media: K.Lac', 'SC Media: K.Lac']
    #Tracer()()
    for jj in range(2):
            ax = axarr[jj]   
            ax.set_title(title_list[jj])     
